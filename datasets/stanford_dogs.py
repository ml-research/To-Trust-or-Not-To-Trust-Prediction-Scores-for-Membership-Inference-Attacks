...
class StanfordDogs(ImageFolder):
    ...
    def __init__(
        ...
        loaded_split_mat = sio.loadmat(os.path.join(self.base_folder, split_fname))
        self.file_list = [
    ...
    def download(self) -> None:
        if self._check_integrity():
            ...
            return
        download_and_extract_archive(self.url, self.base_folder, filename=self.filename, md5=self.tar_md5)
